    ...
    <div class="flex -mx-4 items-center justify-between relative">
        ...
        <a href="/" class="w-full flex items-center py-2">
          <img
            ...
            alt="logo"
            class="w-[50px] lg:w-[64px] py-2 inline-block dark:hidden pointer-events-none"
          />
          <!-- <span class="text-xl xl:text-2xl font-bold text-primary dark:text-white">SAU HOLDING</span> -->
         </a>
        </div>
    </div>
</div>
          ...
          >
            <ul class="block lg:flex lg:items-center">
              ...
              <div class="ml-0 lg:ml-10 xl:ml-16 relative top-1">
                <div class="g-ytsubscribe" data-channelid="UCkLWOh_MlFwa76eAdi4j9eg" data-layout="default"
